...
Phew! We covered a lot, but most of it followed logically from Grassman's law and one key fact: that our eyes detect color using three types of cone cells, each of whose sensitivity peaks in a different section of the EM spectrum. We don't have to memorize every detail of additive and subtractive color mixing, nor the fact that the visible colors can neatly be represented by the convex hull of a planar curve, of which our TVs are limited to a triangular region. These facts follow by deductive logic. The chain of reasoning may seem daunting at first. With practice, you'll not only be able to fill in the details of things you forget, but you'll discover opportunities to apply similar reasoning to a different topic.

For the kids out there, the point is: science is not composed of a laundry list of facts. If it were, technology wouldn't be nearly as powerful as it is today. By relying less on memorization and more on logical connections, you'll be able to learn and retain a lot more information. Furthermore, you'll be able to reason through new situations and apply your knowledge critically to solve new non-textbook problems. As a final note, I believe that critical thinking skills are essential to becoming a responsible citizen; perhaps I'll write about that another time.
